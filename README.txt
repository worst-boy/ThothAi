...
## Technologies Used
- **Telegram Bot API**: To handle messaging and bot interaction (https://core.telegram.org/bots/api).
- **Google Gemini-1.0-Pro API**: Provides generative AI for intelligent responses (https://ai.google.dev/gemini-api/docs).
- **Python**: The core programming language used for scripting the bot (https://www.python.org/downloads/).
- **Telebot**: A Python wrapper for working with the Telegram Bot API (https://pytba.readthedocs.io/en/latest/).
- **Google Generative AI Library**: For integrating the Gemini API (https://pypi.org/project/google-generativeai/).

## Requirements
To run Thoth AI, you will need:
- Python 3.8 or higher
- **Telebot Library**: Install via pip `pip install pyTelegramBotAPI`
